...
public interface MinRecordFilter {
	 ...
	 */
	public static MinRecordFilter ALL = new MinRecordFilter() {
		/**
		 * Returns true.
		 * @return true
		 */
